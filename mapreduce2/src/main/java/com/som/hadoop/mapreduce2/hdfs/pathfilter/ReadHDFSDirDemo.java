...
public class ReadHDFSDirDemo {
  ...
  public static void main(String[] args) {
    ...
    default:
      System.err
          .println("Usage: com.som.hadoop.mapreduce2.hdfs.pathfilter.ReadHDFSDirDemo <Comma seperated HDFS directories to read> [<PathFilterRegex> <include>]");
      System.err
          .println("Usage: com.som.hadoop.mapreduce2.hdfs.pathfilter.ReadHDFSDirDemo /ngdb/ps,/ngdb/es");
      System.err
          .println("Usage: com.som.hadoop.mapreduce2.hdfs.pathfilter.ReadHDFSDirDemo /ngdb/ps *CEI*INDEX* true");
      System.exit(-1);
      break;
    }
    ...
    try {
      ...
      if (args.length == 1) {
        ...
        status =
            fs.listStatus(paths, new RegexExcludeFilter(pathRegexToBeExcluded,
                include));
      }
