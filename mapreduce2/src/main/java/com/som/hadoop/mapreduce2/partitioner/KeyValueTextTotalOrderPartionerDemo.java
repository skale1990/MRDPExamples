...
public class KeyValueTextTotalOrderPartionerDemo extends Configured implements
    Tool {
  ...
  public static void main(String[] args) {
    ...
    try {
      int exitSttus =
          ToolRunner.run(new KeyValueTextTotalOrderPartionerDemo(), args);
  ...
  public int run(String[] args) throws Exception {
    ...
    InputSampler.Sampler<Text, IntWritable> sampler =
        new InputSampler.RandomSampler<Text, IntWritable>(0.1, 1000, 10);
