package com.som.hadoop.mapreduce2.combiner;
...
//			Pattern pattern = Pattern.compile("\\s+");
	...
	public static void main(String[] args) {
		...
		try {
			int exitSttus = ToolRunner.run(conf, new WordCountWithCombiner(), args);
	...
	public int run(String[] args) throws Exception {
		// TODO Auto-generated method stub
		if (args.length != 2) {
			System.err.println("Usage: com.som.hadoop.mapreduce2.combiner.WordCountWithCombiner <input-path> <output-path>");
			System.exit(-1);
		}
		...
		Job job = Job.getInstance(getConf(), "Word Count Example With Combiner");
